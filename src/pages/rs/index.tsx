...
const Links: ILinkGroup[] = [
  {
    ...
    groupDescription: 'A variety of Serbian mobile networking related datasets compiled by the community, available for free.',
    groupLinks: [
      {
        title: 'NR/EARFCN list',
        description: 'A list of Serbian mobile network frequencies by their NRARFCNs and EARFCNs.',
        url: '/rs/arfcn-list',
      },
      {
        title: 'Spectrum allocation',
        description: 'A visualisation of spectrum allocation for mobile networks within Serbia.',
        url: '/rs/spectrum',
      },
    ],
  },
