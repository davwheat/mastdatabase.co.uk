...
const Links: ILinkGroup[] = [
  {
    groupName: 'Datasets',
    groupDescription: 'A variety of Italian mobile networking related datasets compiled by the community, available for free.',
    groupLinks: [
      // {
      //   title: 'NR/EARFCN list',
      //   description: 'A list of Italian mobile network frequencies by their NRARFCNs and EARFCNs.',
      //   url: '/lt/arfcn-list',
      // },
      {
        title: 'Spectrum allocation',
        description: 'A visualisation of spectrum allocation for mobile networks within Italy.',
        url: '/it/spectrum',
      },
    ],
  },
