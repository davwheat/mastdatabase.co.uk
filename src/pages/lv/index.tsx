...
const Links: ILinkGroup[] = [
  {
    groupName: 'Datasets',
    groupDescription: 'A variety of Latvian mobile networking related datasets compiled by the community, available for free.',
    groupLinks: [
      // {
...
export default function MobileNetworkingPage({ location }: PageProps) {
  ...
  return (
    <Layout
      location={location}
      title="Mobile networking in Latvia"
      description="A collection of Latvian mobile networking tools and datasets compiled by the community."
    >
      <Hero firstElement size="large" color={Colors.primaryBlue}>
        <h1 className="text-shout">Mobile networking in Latvia</h1>
        <p role="doc-subtitle" className="text-loud">
          A collection of Latvian mobile networking tools and datasets compiled by the community.
        </p>
      </Hero>
