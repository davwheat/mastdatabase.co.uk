          ...
          __html: JSON.stringify(
            {
              ...
              url: `https://mastdatabase.co.uk/blog/${context.frontmatter.path}`,
              ...
              author: {
                '@type': 'Person',
                name: context.frontmatter.author ?? 'David Wheatley',
                url: context.frontmatter.author_link ?? 'https://davwheat.dev',
              },
              mainEntityOfPage: {
                '@type': 'WebPage',
                '@id': `https://mastdatabase.co.uk/blog/${pageContext.page}`,
              },
            },
            null,
            2,
