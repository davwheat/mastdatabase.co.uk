...
export const StatusMessagesText = {
  loading: (
    <span style={{ display: 'flex', alignItems: 'center' }}>
      <LoadingSpinner inline size="1.1em" style={{ marginRight: 12, flexShrink: 0 }} /> Loading sites...
    </span>
  ),
  fetchFail: 'Failed to load sites. Check your internet connection.',
  upstreamError: 'An error occurred with the API. Please try again later.',
} as const

const InfoStatusKeys: StatusMessageKey[] = ['loading']
const ErrorStatusKeys: StatusMessageKey[] = ['fetchFail', 'upstreamError']
