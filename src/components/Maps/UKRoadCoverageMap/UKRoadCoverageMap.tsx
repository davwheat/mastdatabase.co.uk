...
export interface UKRoadCoverageMapProps {
  data: Promise<geojson.FeatureCollection<geojson.Geometry, geojson.GeoJsonProperties>>[]
  style?: PathOptions
  network: string
}

export default function UKRoadCoverageMap({ data, style, network }: UKRoadCoverageMapProps) {
  useFixLeafletAssets()
...
function MapLayers({ data, style, network }: UKRoadCoverageMapProps) {
