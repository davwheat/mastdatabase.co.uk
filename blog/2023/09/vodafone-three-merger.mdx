...
<p>For spectrum totals in this section, I have excluded holdings within B67 supplemental uplink and n77 C-band.</p>

<p style={{ marginBottom: 0 }}>B67 is not supported by any consumer devices and Three's n77 license does not permit usage for mobile coverage.</p>
</MinorAlert>
</aside>
...
is over two times the amount of spectrum held by the next network, EE, at 210&nbsp;MHz (plus 20&nbsp;MHz B67 SUL).
...
performance. Looking at other three-network markets, such as Denmark<sup id="note-1-link">[\[1\]](#note-1)</sup>, we can see spectrum holdings
...
promising outlook for Vodafone and Three. A similar merger in the USA between T-Mobile and Sprint is wellknown as a failure, resulting in
...
last year alone (Sep 2022: 113p; Sep 2023: 73p), despite improving annual operating profits since at least 2019. Compared to the Group's other
European markets, the UK is one of the least successful and least profitable. It may be the case that without this merger, Vodafone UK may not be
able to survive in the long-term, or will require substantial "bank of mum and dad" funding from the Group's more profitable sectors.

Noone will be able to say for certain the effects of a merger between the two mobile networks. It could be a huge success, or it could be a
...
<sup id="note-1">[\[1\]](#note-1-link)</sup> While Denmark has four networks, Telia and Telenor share all spectrum holdings and infrastructure, and
operate a single MOCN network under the joint-venture TT-Netværket. They, too, attempted a merger in 2014-15, but failed to agree conditions with
EU regulators.
