...
[Ofcom's published return on capital employed figures](https://www.ofcom.org.uk/__data/assets/excel_doc/0032/233699/mno-roce-calculations.xlsx),
Vodafone is the only network whose ROCE is negative, and it has been negative for at least 3 years before 2020, indicating there are significant
inefficiencies in Vodafone UK that require attention. In comparison, Three's ROCE was 3% and Virgin Media O2's was 11.6% is 2020. On the other
hand, it is likely that upon a successful merger, the joint-venture business will be much more efficient and more profitable.
...
<sup id="note-1">[\[1\]](#note-1-link)</sup> Unbundling, or its full term "local loop unbundling", is the process of allowing multiple telecoms networks
to utilise connections from a telephone exchange to a customer's premises.

<sup id="note-2">[\[2\]](#note-2-link)</sup> While Denmark has four networks, Telia and Telenor share all spectrum holdings and infrastructure, and
