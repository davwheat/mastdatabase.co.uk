...
In the end, the merged company opted to divest a quarter (15&nbsp;MHz paired) of their 1800&nbsp;MHz spectrum, as well as other concessions, to
allow the merger to pass through competition regulators.

### Current spectrum outlook

We have a [full page on UK spectrum allocations](/gb/spectrum), but we can summarise total allocations per-network.
