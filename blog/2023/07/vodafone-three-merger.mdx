...
is over two times the amount of spectrum held by the next network, EE, at 230&nbsp;MHz.
...
totalling 230&nbsp;MHz, on top of Three's 84&nbsp;MHz n77 allocation (usage not currently permitted for mobile coverage).
...
- 5&nbsp; MHz block of B20 (800&nbsp;MHz) transferred to EE
  - This results in an even 10&nbsp;MHz per operator
- 20&nbsp;MHz block of B32 (1500&nbsp;MHz) transferred to O2
  - Most devices do not support B32+B32 aggregation, so having 40&nbsp;MHz of B32 would be pointless for VHUK
